      ...
      <Container>
        ...
        <div className="mt-10 grid gap-6 lg:grid-cols-5">
          <Reveal delay={0.05} className="lg:col-span-3">
            <SpotlightCard className="flex h-full flex-col justify-between rounded-3xl border border-zinc-200 bg-white p-8 dark:border-white/10 dark:bg-zinc-950">
              <div>
                <span className="flex h-11 w-11 items-center justify-center rounded-2xl bg-emerald-50 text-emerald-700 dark:bg-emerald-500/10 dark:text-emerald-400">
                  <Wallet size={24} weight="fill" />
                </span>
                <h3 className="font-display mt-5 text-xl font-semibold text-zinc-900 dark:text-zinc-50">
              ...
              <dl className="mt-8 grid grid-cols-2 gap-6 border-t border-zinc-100 pt-6 dark:border-white/10">
                <div>
          ...
          <div className="flex flex-col gap-6 lg:col-span-2">
            <Reveal delay={0.1}>
              <SpotlightCard className="rounded-3xl border border-zinc-200 bg-white p-6 dark:border-white/10 dark:bg-zinc-950">
                <span className="flex h-11 w-11 items-center justify-center rounded-2xl bg-emerald-50 text-emerald-700 dark:bg-emerald-500/10 dark:text-emerald-400">
                  <CalendarCheck size={22} weight="fill" />
                </span>
                <h3 className="font-display mt-4 text-lg font-semibold text-zinc-900 dark:text-zinc-50">
                  Lịch tập với PT
                </h3>
